export const projects = [
  ...
  ["02", "HR Payroll", "Web App", "HRIS", 1, "A centralized HR and payroll platform for managing employee records, attendance, compensation, and accurate payroll processing.", "/hris.mp4"],
